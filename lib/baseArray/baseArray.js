class BaseArray {
   ...
   * @param {number|bigint} value - The value to set at the specified index.
   */
  set(index, value) {
   ...
   * @param {number} [end=this.length] - The end index (not included).
   ...
   *
   * @param {Function} callbackFn - A function that tests each element.
   * @returns {object} Same array containing elements that satisfy the condition.
   */
  filter(callbackFn) {
    var arr = this.array();
    var index = 0;
