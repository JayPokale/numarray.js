...
class BaseArray {
   ...
   * @param {Array} array - The array that `value` belongs to.
   ...
   *
   * @param {ArrayCallback} callbackFn - A function that tests each element.
   ...
   * @param {any} [thisArg=undefined] - An object to use as this when executing the callback.
   * @returns {object} The new array with the results of calling the provided function on each element.
   */
   ...
   *
   * @param {ArrayCallback} callbackFn - A function to execute on each element.
